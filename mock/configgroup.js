...
function getConfigGroup(req, res, u) {
  let url = u;
...
function postConfigGroup(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/config/group/index': getConfigGroup,
  'POST /api/config/group/store': postConfigGroup,
  'POST /api/config/group/update': postConfigGroup,
  'POST /api/config/group/enable': postConfigGroup,
  'POST /api/config/group/destroy': postConfigGroup,
};
