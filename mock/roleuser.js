...
function getRoleUser(req, res, u) {
  let url = u;
...
function postRoleUser(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/roles/user/index': getRoleUser,
  'POST /api/roles/user/store': postRoleUser,
  'POST /api/roles/user/update': postRoleUser,
  'POST /api/roles/user/enable': postRoleUser,
  'POST /api/roles/user/destroy': postRoleUser,
};
