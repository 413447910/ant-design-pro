...
function postConfig(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/config/index': getConfig,
  'POST /api/config/store': postConfig,
  'POST /api/config/update': postConfig,
  'POST /api/config/enable': postConfig,
  'POST /api/config/destroy': postConfig,
};
