...
function getCmsProductTag(req, res, u) {
  let url = u;
...
function postCmsProductTag(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/cms/product/tag/index': getCmsProductTag,
  'POST /api/cms/product/tag/store': postCmsProductTag,
  'POST /api/cms/product/tag/update': postCmsProductTag,
  'POST /api/cms/product/tag/enable': postCmsProductTag,
  'POST /api/cms/product/tag/destroy': postCmsProductTag,
};
