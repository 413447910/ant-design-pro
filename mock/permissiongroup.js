...
function getPermissionGroup(req, res, u) {
  let url = u;
...
function postPermissionGroup(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/permissions/group/index': getPermissionGroup,
  'POST /api/permissions/group/store': postPermissionGroup,
  'POST /api/permissions/group/update': postPermissionGroup,
  'POST /api/permissions/group/enable': postPermissionGroup,
  'POST /api/permissions/group/destroy': postPermissionGroup,
};
