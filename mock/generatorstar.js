...
function getGeneratorStar(req, res, u) {
  let url = u;
...
function postGeneratorStar(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/generator/star/index': getGeneratorStar,
  'POST /api/generator/star/store': postGeneratorStar,
  'POST /api/generator/star/update': postGeneratorStar,
  'POST /api/generator/star/enable': postGeneratorStar,
  'POST /api/generator/star/destroy': postGeneratorStar,
};
