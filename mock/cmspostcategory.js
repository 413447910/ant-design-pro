...
function getCmsPostCategory(req, res, u) {
  let url = u;
...
function postCmsPostCategory(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/cms/post/category/index': getCmsPostCategory,
  'POST /api/cms/post/category/store': postCmsPostCategory,
  'POST /api/cms/post/category/update': postCmsPostCategory,
  'POST /api/cms/post/category/enable': postCmsPostCategory,
  'POST /api/cms/post/category/destroy': postCmsPostCategory,
};
