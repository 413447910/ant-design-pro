...
function getExamplePost(req, res, u) {
  let url = u;
...
function postExamplePost(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/example/post/index': getExamplePost,
  'POST /api/example/post/store': postExamplePost,
  'POST /api/example/post/update': postExamplePost,
  'POST /api/example/post/enable': postExamplePost,
  'POST /api/example/post/destroy': postExamplePost,
};
