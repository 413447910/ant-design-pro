...
function getExampleGroup(req, res, u) {
  let url = u;
...
function postExampleGroup(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/example/group/index': getExampleGroup,
  'POST /api/example/group/store': postExampleGroup,
  'POST /api/example/group/update': postExampleGroup,
  'POST /api/example/group/enable': postExampleGroup,
  'POST /api/example/group/destroy': postExampleGroup,
};
