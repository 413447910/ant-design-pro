...
function getGenerator(req, res, u) {
  let url = u;
...
function postGenerator(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/generator/index': getGenerator,
  'POST /api/generator/store': postGenerator,
  'POST /api/generator/update': postGenerator,
  'POST /api/generator/enable': postGenerator,
  'POST /api/generator/destroy': postGenerator,
};
