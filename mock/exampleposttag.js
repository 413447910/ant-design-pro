...
function getExamplePostTag(req, res, u) {
  let url = u;
...
function postExamplePostTag(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/example/post/tag/index': getExamplePostTag,
  'POST /api/example/post/tag/store': postExamplePostTag,
  'POST /api/example/post/tag/update': postExamplePostTag,
  'POST /api/example/post/tag/enable': postExamplePostTag,
  'POST /api/example/post/tag/destroy': postExamplePostTag,
};
