...
function getCmsScrapy(req, res, u) {
  let url = u;
...
function postCmsScrapy(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/cms/scrapy/index': getCmsScrapy,
  'POST /api/cms/scrapy/store': postCmsScrapy,
  'POST /api/cms/scrapy/update': postCmsScrapy,
  'POST /api/cms/scrapy/enable': postCmsScrapy,
  'POST /api/cms/scrapy/destroy': postCmsScrapy,
};
