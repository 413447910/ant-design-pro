...
function getExampleCategory(req, res, u) {
  let url = u;
...
function postExampleCategory(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/example/category/index': getExampleCategory,
  'POST /api/example/category/store': postExampleCategory,
  'POST /api/example/category/update': postExampleCategory,
  'POST /api/example/category/enable': postExampleCategory,
  'POST /api/example/category/destroy': postExampleCategory,
};
