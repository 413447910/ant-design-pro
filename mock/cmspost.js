...
function postCmsPost(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/cms/post/index': getCmsPost,
  'POST /api/cms/post/store': postCmsPost,
  'POST /api/cms/post/update': postCmsPost,
  'POST /api/cms/post/enable': postCmsPost,
  'POST /api/cms/post/destroy': postCmsPost,
};
