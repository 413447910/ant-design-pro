...
function getCmsCategory(req, res, u) {
  let url = u;
...
function postCmsCategory(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/cms/category/index': getCmsCategory,
  'POST /api/cms/category/store': postCmsCategory,
  'POST /api/cms/category/update': postCmsCategory,
  'POST /api/cms/category/enable': postCmsCategory,
  'POST /api/cms/category/destroy': postCmsCategory,
};
