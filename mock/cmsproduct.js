...
function getCmsProduct(req, res, u) {
  let url = u;
...
function postCmsProduct(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/cms/product/index': getCmsProduct,
  'POST /api/cms/product/store': postCmsProduct,
  'POST /api/cms/product/update': postCmsProduct,
  'POST /api/cms/product/enable': postCmsProduct,
  'POST /api/cms/product/destroy': postCmsProduct,
};
