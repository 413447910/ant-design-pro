...
function getPermission(req, res, u) {
  let url = u;
...
function postPermission(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/permissions/index': getPermission,
  'POST /api/permissions/store': postPermission,
  'POST /api/permissions/update': postPermission,
  'POST /api/permissions/enable': postPermission,
  'POST /api/permissions/destroy': postPermission,
};
