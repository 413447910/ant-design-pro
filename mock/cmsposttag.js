...
function getCmsPostTag(req, res, u) {
  let url = u;
...
function postCmsPostTag(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/cms/post/tag/index': getCmsPostTag,
  'POST /api/cms/post/tag/store': postCmsPostTag,
  'POST /api/cms/post/tag/update': postCmsPostTag,
  'POST /api/cms/post/tag/enable': postCmsPostTag,
  'POST /api/cms/post/tag/destroy': postCmsPostTag,
};
