...
function postCmsTag(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
...
export default {
  'GET /api/cms/tag/index': getCmsTag,
  'POST /api/cms/tag/store': postCmsTag,
  'POST /api/cms/tag/update': postCmsTag,
  'POST /api/cms/tag/enable': postCmsTag,
  'POST /api/cms/tag/destroy': postCmsTag,
};
