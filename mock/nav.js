...
export default {
  'GET /api/nav/index': getNav,
  'POST /api/nav/store': postNav,
  'POST /api/nav/update': postNav,
  'POST /api/nav/enable': postNav,
  'POST /api/nav/destroy': postNav,
};
