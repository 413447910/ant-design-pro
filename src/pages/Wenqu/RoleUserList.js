...
import styles from './RoleUserList.less';
...
@connect(({ roleuser, loading }) => ({
  roleuser,
  loading: loading.models.roleuser,
}))
@Form.create()
class RoleUserList extends PureComponent {
  state = {
    modalVisible: false,
    isUpdate: false,
    selectedRows: [],
