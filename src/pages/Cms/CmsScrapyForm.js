...
@Form.create()
class CmsScrapyForm extends PureComponent {
  ...
  render(){
    ...
    return (
      ...
      >
        ...
        {
          !hiddenFields.includes('unzipSubPath') &&
          <FormItem labelCol={{span: 5}} wrapperCol={{span: 15}} label="解压子路径">
            {form.getFieldDecorator('unzipSubPath', {
              initialValue: formValues.unzipSubPath || '',
              rules: [{required: true, message: '解压子路径不能为空！'}],
            })(<Input placeholder="" />)}
          </FormItem>
        }
