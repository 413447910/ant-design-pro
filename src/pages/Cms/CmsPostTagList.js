...
import CmsPostTagForm from './CmsPostTagForm';
...
@connect(({ cmsposttag, loading }) => ({
  cmsposttag,
  loading: loading.models.cmsposttag,
}))
@Form.create()
class CmsPostTagList extends PureComponent {
  state = {
    modalVisible: false,
    isUpdate: false,
    selectedRows: [],
