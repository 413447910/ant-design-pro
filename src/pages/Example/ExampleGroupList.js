...
import ExampleGroupForm from './ExampleGroupForm';
import {componentHiddenFields, getValue} from '@/utils/BdHelper';

import styles from './ExampleGroupList.less';

const FormItem = Form.Item;


/* eslint react/no-multi-comp:0 */
@connect(({ examplegroup, loading }) => ({
  examplegroup,
  loading: loading.models.examplegroup,
}))
@Form.create()
class ExampleGroupList extends PureComponent {
  state = {
    modalVisible: false,
    isUpdate: false,
    selectedRows: [],
  ...
  render() {
    ...
    return (
      <PageHeaderWrapper title="Group模版">
        <Card bordered={false}>
...
export default ExampleGroupList;
