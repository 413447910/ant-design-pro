...
@connect(({ examplepost, loading }) => ({
  examplepost,
  loading: loading.models.examplepost,
}))
@Form.create()
class ExamplePostList extends PureComponent {
  state = {
    modalVisible: false,
    isUpdate: false,
    selectedRows: [],
...
export default ExamplePostList;
