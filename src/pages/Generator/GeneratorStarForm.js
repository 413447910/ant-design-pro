...
@Form.create()
class GeneratorStarForm extends PureComponent {
  ...
  render(){
    ...
    return (
      ...
      >
        ...
        {
          !hiddenFields.includes('jsonFileArr') &&
          <FormItem labelCol={{span: 5}} wrapperCol={{span: 15}} label="备注">
            {form.getFieldDecorator('jsonFileArr', {
              initialValue: formValues.jsonFileArr || '',
              rules: [],
            })(<TextArea rows={20} placeholder="" disabled />)}
          </FormItem>
        }
...
export default GeneratorStarForm;
