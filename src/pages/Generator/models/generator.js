import {queryGenerator, updateGenerator, destroyGenerator , storeGenerator, enableGenerator} from '@/services/generator';
...
export default {
  ...
  effects: {
    ...
    *store({ payload, callback }, { call, put }) {
      const response = yield call(storeGenerator, payload);
    ...
    *destroy({ payload, callback }, { call, put }) {
      const response = yield call(destroyGenerator , payload);
    ...
    *enable({ payload, callback }, { call, put }) {
      const response = yield call(enableGenerator, payload);
